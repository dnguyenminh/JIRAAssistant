...
2. Read `documents/{TICKET-KEY}/TDD.md` — REQUIRED (primary source for implementation).
3. Read `documents/{TICKET-KEY}/FSD.md` — REQUIRED (for business rules and validation logic).
4. Read `documents/{TICKET-KEY}/BRD.md` — OPTIONAL (for business context).
5. If TDD is missing, inform user: "Cần có TDD trước khi implement. Hãy chạy sa-agent trước."
