...
- [x] 125.1 Tạo `frontend/src/jsMain/kotlin/com/assistant/frontend/components/chat/AIConfigPopupForm.kt`:
...
- [x] 125.3 Tạo Workflow Popup Form:
...
- [x] 126.1 Tạo Instruction Popup Form:
...
- [x] 126.3 Cập nhật `AIConfigPanel.kt` — chuyển 4 bảng từ inline editable sang summary tables (read-only):
...
- [x] 127.1 Cập nhật `frontend/src/jsMain/resources/styles/components.css`:
...
- [x] 128. 4 popup modal forms (Skill, Workflow, Instruction, Rule) mở đúng khi click ➕ hoặc click dòng. Validation required fields (viền đỏ, không đóng modal). Backdrop click / Escape đóng modal. Summary tables read-only hiển thị dữ liệu rút gọn. Save/Cancel hoạt động đúng. Ensure all tests pass, ask the user if questions arise.
...
- [x] 129.1 Tạo `server/src/jvmMain/kotlin/com/assistant/server/chat/models/AIModelContext.kt`:
...
- [x] 130.1 Tạo `server/src/jvmMain/kotlin/com/assistant/server/chat/ResponseFormatDetector.kt`:
...
- [x] 131.1 Tạo `server/src/jvmMain/kotlin/com/assistant/server/chat/ToolCallFormatDetector.kt`:
...
- [x] 132.1 Cập nhật `server/src/jvmMain/kotlin/com/assistant/server/chat/ChatResponseParser.kt`:
...
- [x] 133.1 Cập nhật `server/src/jvmMain/kotlin/com/assistant/server/chat/McpAgenticLoop.kt`:
...
- [x] 134.1 Cập nhật `server/src/jvmMain/kotlin/com/assistant/server/chat/ChatServiceImpl.kt`:
...
- [x] 134.2 Cập nhật `server/src/jvmMain/kotlin/com/assistant/server/di/ServerModule.kt`:
...
- [x] 135.1 Tạo `server/src/jvmTest/kotlin/com/assistant/server/chat/ResponseFormatDetectorTest.kt`:
...
- [x] 136.1 Tạo `server/src/jvmTest/kotlin/com/assistant/server/chat/ToolCallFormatDetectorTest.kt`:
...
- [x] 137.1 Tạo `server/src/jvmTest/kotlin/com/assistant/server/chat/ResponseFormatDetectorPropertyTest.kt`:
...
- [x] 137.2 Tạo `server/src/jvmTest/kotlin/com/assistant/server/chat/AutoDetectPropertyTest.kt`:
...
- [x] 138.1 Tạo hoặc cập nhật `server/src/jvmTest/kotlin/com/assistant/server/chat/ChatResponseParserRegressionTest.kt`:
