...
kotlin {
    ...
    sourceSets {
        jvmMain.dependencies {
            ...
            // Ktor Client Engine (used by EmbeddingServiceImpl, AttachmentDownloaderImpl)
            ...
            // PostgreSQL JDBC driver (for PgVectorStoreImpl)
            implementation("org.postgresql:postgresql:42.7.5")

            // pgvector Java support (for PgVectorStoreImpl)
        ...
        jvmTest.dependencies {
            ...
            // HikariCP (for PgVectorStorePropertyTest)
